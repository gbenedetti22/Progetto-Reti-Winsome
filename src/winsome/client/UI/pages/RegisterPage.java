...
import winsome.client.UI.components.PasswordField;
...
import winsome.client.mainFrame.ClientProperties;
...
public class RegisterPage extends JPanel {
    ...
    public RegisterPage() {
        ...
        try {
            Registry registry = LocateRegistry.getRegistry((String) props.get(ClientProperties.NAMES.RMI_ADDRESS), (int) props.get(ClientProperties.NAMES.RMI_REG_PORT));
