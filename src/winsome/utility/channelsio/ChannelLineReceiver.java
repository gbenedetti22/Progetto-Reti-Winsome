...
/**
 * Classe che permette di ricevere i dati inviati da {@link ChannelLineSender} (su uno o più canali).<br>
 * Il metodo {@link #receiveLine()} garantisce che ad ogni chiamata di {@link ChannelLineSender#sendLine(String)} sia associata
 ...
 * <br>
 * Il chiamante è invitato a non allocare di continuo nuovi {@link ChannelLineSender}/{@link ChannelLineReceiver} in quanto, ad oogni nuova allocazione,
 * vengono allocati nuovi buffer e ciò potrebbe comportare in un calo di prestazioni.<br>{@link ChannelLineSender} e {@link ChannelLineReceiver}
 ...
 * Per l uso su più thread vedere la versione {@link ConcurrentChannelLineReceiver}.<br>
 */
public class ChannelLineReceiver implements ChannelReceiver {
     ...
     */
    public ChannelLineReceiver(SocketChannel channel) {
     ...
     */
    public ChannelLineReceiver() {
        this(null);
    }

    /**
     * Riceve una riga di testo inviata da {@link ChannelLineSender#sendLine(String)}.<br>
     * Il canale d ascolto è quello settato mediante setChannel() o quello passato al costruttore<br>
     * <br>
     *
     * @return la riga di testo inviata mediante {@link ChannelLineSender#sendLine(String)} o null se il canale è chiuso,
     ...
     *
     * @param channel il canale su cui ricevere
     */
    ...
    /**
     * Permette di ottenere il canale su cui questo {@link ChannelLineReceiver} sta ascoltando<br>
     *
    ...
    /**
     * Riceve l intero inviato mediante il metodo {@link ChannelLineSender#sendInteger(int)} <br>
     * <br>
     *
    ...
    /**
     * Riceve e decodifica l oggetto inviato mediante {@link ChannelLineSender#sendObject(Object)}<br>
     * <br>
     *
